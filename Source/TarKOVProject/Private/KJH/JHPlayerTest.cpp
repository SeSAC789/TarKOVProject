...
void AJHPlayerTest::BeginPlay()
{
	...
	HeadHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	ThoraxHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	StomachHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	RightArmUpperHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	RightForeArmHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	LeftArmUpperHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	LeftForeArmHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	RightLegUpperHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	RightLegLowerHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	LeftLegUpperHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
	LeftLegLowerHitbox->OnComponentBeginOverlap.AddDynamic( this , &AJHPlayerTest::OnHitboxOverlap );
